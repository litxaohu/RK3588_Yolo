...
from py_utils.yolov5_utils import post_process, draw, CLASSES, IMG_SIZE
            ...
            while not self._stop_event.is_set():
                ...
                if self.model and self.co_helper and self.anchors:
                    ...
                    if outputs is not None:
                        ...
                        boxes, classes, scores = post_process(outputs, self.anchors, obj, nms)
...
def main():
    ...
    global _global_model, _global_co_helper, _global_anchors
    ...
    try:
        while True:
            ...
            if outputs is not None:
                obj, nms = det_config.get()
                boxes, classes, scores = post_process(outputs, _global_anchors, obj, nms)
                if boxes is not None:
