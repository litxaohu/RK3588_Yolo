# RK3588 YOLOv5 高性能 Web 服务

本项目在瑞芯微 RK3588 平台上基于 RKNN-Toolkit-Lite2 实现了 YOLOv5 目标检测模型的高性能部署。采用纯 Python 架构，去除了本地 GUI 依赖，专注于集成 FastAPI 提供高并发 Web API 与 MJPEG 视频流，完美契合工业级量产后端部署需求。
