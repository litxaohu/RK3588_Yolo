...
# --- FastAPI Components ---
app = FastAPI(title="RK3588 YOLOv8-OBB Web Preview")
...
async def index():
    ...
    <html>
      <head>
        <title>RK3588 YOLOv8-OBB Preview</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>RK3588 YOLOv8-OBB Real-time Detection</h1>
...
def main():
    parser = argparse.ArgumentParser(description='YOLOv8-OBB detection on RK3588')
