# RK3588 YOLOv8 Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains YOLOv8 inference code optimized for RK3588.
...
- `model/`: Stores `.rknn` models converted for RK3588 (e.g., `yolov8n.rknn`).
...
sudo docker run --rm --privileged --net=host \
    ...
    recomputer-rk-cv/debug/rk3588_yolov8:latest \
