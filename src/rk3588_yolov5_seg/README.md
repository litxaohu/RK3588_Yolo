# RK3588 YOLOv5-Seg Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains YOLOv5-Seg instance segmentation inference code optimized for RK3588.
...
- `model/`: Stores `.rknn` models converted for RK3588 (e.g., `yolov5s-seg.rknn`).
...
sudo docker run --rm --privileged --net=host \
    ...
    recomputer-rk-cv/debug/rk3588_yolov5_seg:latest \
