# RK3576 YOLOv8-Pose 实时检测与 Web 预览项目

该项目基于 RKNN-Toolkit-Lite2，在瑞芯微 RK3576 平台上实现 YOLOv8-Pose 人体姿态估计模型的高性能部署。项目采用纯 Python 架构，集成了 FastAPI 提供 Web API 和 MJPEG 视频流预览，同时支持本地 GUI 实时显示。
...
- 项目已默认配置使用 `RKNNLite.NPU_CORE_0_1_2`，充分利用 RK3576 的 3 个 NPU 核心 (2 TOPS 算力)。
