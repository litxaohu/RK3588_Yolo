# RK3576 Whisper 语音识别 Web 服务与 API 引擎

本项目实现了在瑞芯微 RK3576 平台上，基于 RKNN-Toolkit-Lite2 对 Whisper 模型的高性能部署。采用纯 Python 架构，集成了 FastAPI，提供强大的 Web 交互界面以及工业级的标准 RESTful API 接口，支持短音频同步分析与长音频异步切片分析。
